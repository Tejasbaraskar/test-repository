...
//	}
	...
	public void settingFlight(@PathVariable("aircraftId") Long aircraftId,@PathVariable("departureAirport")int departureAirport,@PathVariable("destinationAirport") int destinationAirport,@PathVariable("departureTime") String departureTime,@PathVariable("arrivalTime") String arrivalTime,@RequestBody Flight flight) {
	...
	public List<Flight> setSearchFlight(@PathVariable("departureAirport") int departureAirport,@PathVariable("destinationAirport") int destinationAirport,@PathVariable("departureTime") String departureTime) {
	...
	public List<Flight> setBookFlight(@PathVariable("departureAirport") int departureAirport,@PathVariable("destinationAirport") int destinationAirport,@PathVariable("departureTime") String departureTime) {
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		LocalDate deptTime = LocalDate.parse(departureTime, dtf);
		Airport depAirport = airportService.getAirportById(departureAirport);
		Airport destAirport = airportService.getAirportById(destinationAirport);
...
//	}
	...
	public Passenger getPassengers1(@PathVariable("flightId") long flightId,@PathVariable("passengerId") long passengerId) {
